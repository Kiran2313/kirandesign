        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <p className="text-muted-foreground leading-relaxed">
              Currently in the final semester of B.Tech in Computer Science Engineering at Sri Indu College of Engineering & Technology. My technical foundation combined with creative thinking enables me to design digital products that are both functional and visually engaging.
            </p>
